...
owns media-index replacement, selected-entry preservation helpers, and the
playback-preference contract used by Android TV Player/Settings and Windows
playback settings, keeping those state-merge and playback-end preference rules
out of platform UI shells. Android business modules were tightened so
...
milliseconds, matching the shared model.
