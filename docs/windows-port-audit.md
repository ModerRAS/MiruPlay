...
`build/desktop-behavior/run-20260526-140442/report.json`, but live CloudDrive2
end-to-end QA, target-hardware RIFE validation, signed release installer
evidence, packaged/browser WebUI E2E evidence, and deeper desktop-vs-TV UI parity
for less-traveled keyboard/DPAD focus paths remain open.
...
Latest desktop behavior smoke passed in Gradle MCP build `b-14`; its local
report is `build/desktop-behavior/run-20260526-140442/report.json`.
