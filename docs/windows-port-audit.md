...
and has unit-covered directional saved-source movement,
...
transport paths by keyboard input.
...
1. Continue narrowing TV parity gaps in less-traveled keyboard/DPAD focus paths outside the now-covered Settings category menu, desktop route rail, Library poster wall, Details hero actions, Continue watching recents, remote browser list including parent navigation, Player transport controls, Bangumi metadata lists, and unit-covered saved-source card movement. Real-window GUI focus capture for saved-source card switching should be revisited in the next keyboard smoke expansion.
