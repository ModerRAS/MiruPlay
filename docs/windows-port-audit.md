...
watching Enter, WebDAV remote-browser Up to parent plus Down to Enter, and Player
paths by keyboard input.
...
1. Continue narrowing TV parity gaps in less-traveled keyboard/DPAD focus paths outside the now-covered Settings category menu, desktop route rail, Library poster wall, Details hero actions, Continue watching recents, remote browser list including parent navigation, Player transport controls, and Bangumi metadata lists.
