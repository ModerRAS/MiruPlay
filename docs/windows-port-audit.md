...
Enter, Details hero Right to Left to Enter, and WebDAV remote-browser Down to
Enter paths by keyboard input.
...
1. Continue narrowing TV parity gaps in less-traveled keyboard/DPAD focus paths outside the now-covered Settings category menu, desktop route rail, Library poster wall, Details hero actions, remote browser list, Player transport controls, and Bangumi metadata lists.
