...
`build/desktop-behavior/run-20260527-072916/report.json`, plus a packaged
...
`build/desktop-behavior/run-20260527-072916/report.json`, and the scheduler
report is `build/cloud-rss-smoke/scheduler-report.json`. Separately,
