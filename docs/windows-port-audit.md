...
uses TV-facing source type labels and Chinese source-management controls,
...
`build/desktop-source-management-ui/run-20260520-210229/source-management-saved-source-keyboard.png`,
...
The source-management label pass also localizes the local scan/search controls,
WebDAV/SMB controls, saved-source type labels, remote-browser title/status, and
...
`build/desktop-bangumi-metadata-ui/run-20260520-163523/bangumi-details-ready.png`,
