...
`build/desktop-behavior/run-20260526-154603/report.json`, plus a packaged
...
Latest desktop behavior smoke passed in Gradle MCP build `b-39`; its local
report is `build/desktop-behavior/run-20260526-154603/report.json`. Packaged
