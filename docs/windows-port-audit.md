...
Details. Real Windows GUI smokes prove Sources to CloudDrive, Details to Player,
and poster-wall Right to Enter paths by keyboard input.
...
`build/desktop-local-source-ui/run-20260520-101021/local-source-poster-keyboard.png`,
...
1. Continue narrowing TV parity gaps in less-traveled keyboard/DPAD focus paths outside the now-covered Settings category menu, desktop route rail, and Library poster wall.
