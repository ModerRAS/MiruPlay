...
desktop-vs-TV UI parity for unusual keyboard/DPAD focus paths remain open.
...
subscription/scheduler cards instead of one dense automation form.
...
1. Continue narrowing TV parity gaps in unusual keyboard/DPAD focus paths.
