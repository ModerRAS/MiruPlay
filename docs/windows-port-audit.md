...
runs `:desktop-app:desktopBehaviorTest -PdesktopBehaviorTags=smoke -PbundleMpvRuntime=false`,
and uploads the desktop behavior `report.json` plus screenshots; nightly
main/master releases attach the same-version ZIP alongside the Android APK
