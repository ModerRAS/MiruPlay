...
with a real Windows GUI smoke proving keyboard movement from Sources to
CloudDrive and Details to Player.
...
1. Continue narrowing TV parity gaps in less-traveled keyboard/DPAD focus paths outside the now-covered Settings category menu and desktop route rail.
