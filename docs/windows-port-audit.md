...
owns media-index replacement and selected-entry preservation helpers used by
desktop batch apply/undo/review flows, keeping that state-merge rule out of the
Compose entry. Android business modules were tightened so
