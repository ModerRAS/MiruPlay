...
`build/desktop-local-source-ui/run-20260520-104011/local-source-poster-keyboard.png`,
...
1. Continue narrowing TV parity gaps in less-traveled keyboard/DPAD focus paths outside the now-covered Settings category menu, desktop route rail, Library poster wall, remote browser list, and Player transport controls.
