...
- [x] Add a Windows native app-image gate that builds with JDK `jpackage` and verifies the launcher, generated launcher config/classpath, and bundled mpv/RIFE runtime.
...
- [x] Keep CI green for Android and desktop/shared JVM gates on the active `codex/windows-mpv-rife` branch (`CI Build` run `26214451190` passed build/lint on commit `57c567a`).
