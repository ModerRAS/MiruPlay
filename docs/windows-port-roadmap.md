...
- [x] Rework the Windows Library first screen toward the Android TV Library: full-width Explore header, Scan/Settings actions, TV empty state, and poster wall after scan.
