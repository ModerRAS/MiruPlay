...
- [x] Add Android TV smoke coverage for Library poster focus and DPAD poster -> Details episode row -> Player -> Back to Library poster wall -> Settings.
