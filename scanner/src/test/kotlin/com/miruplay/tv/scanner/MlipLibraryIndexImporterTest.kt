...
class MlipLibraryIndexImporterTest {
    ...
    fun `valid mlip database imports index metadata episodes and poster`() = runBlocking {
        ...
        try {
            ...
            assertEquals(5678L, entry.lastModified)
    ...
    private fun createMlipDatabase(
        ...
        try {
            ...
            database.execSQL("INSERT INTO media_file (id, episode_id, path, size, modified_time) VALUES (100, 10, '$mediaPath', 1234, 5678)")
            database.execSQL("INSERT INTO media_file (id, episode_id, path, size, modified_time) VALUES (101, 11, 'Series/01.5.mkv', 1234, 5679)")
