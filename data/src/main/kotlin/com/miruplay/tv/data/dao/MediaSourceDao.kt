...
interface MediaSourceDao {
    ...
    @Query("UPDATE media_source SET name = :name, url = :url, username = :username, password = :password, extra_config = :extraConfig, is_connected = :isConnected, last_scanned = :lastScanned WHERE id = :id")
    suspend fun update(id: Long, name: String? = null, url: String? = null, username: String? = null, password: String? = null, extraConfig: String? = null, isConnected: Boolean? = null, lastScanned: Long = 0L)
