...
class OpenObserveJsonPayloadBuilderTest {
    ...
    fun `exception fields are included in json ingestion payload`() {
        ...
        assertEquals("miruplay-android-tv", item.getValue("service_name").jsonPrimitive.content)
        assertEquals("android-tv", item.getValue("deployment_environment").jsonPrimitive.content)
