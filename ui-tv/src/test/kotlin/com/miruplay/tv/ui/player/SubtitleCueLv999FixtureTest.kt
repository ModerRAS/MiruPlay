...
class SubtitleCueLv999FixtureTest {
    ...
    @Test
    fun `LV999 dialogue merges while positioned sign keeps ASS placement`() {
        ...
        assertEquals(
            "First dialogue JP\nFirst dialogue CN\nSecond dialogue JP\nSecond dialogue CN",
            restackSubtitleCues(fourDialogueCues).single().text.toString(),
        )
    ...
    private fun parseFixture(): List<CuesWithTiming> {
        val ass = """
            ...
            Style: Dialogue,Arial,50,&H00FFFFFF,&H000000FF,&H00000000,&H64000000,0,0,0,0,100,100,0,0,1,2,0,2,20,20,40,1
            Style: Sign,Arial,36,&H00FFFFFF,&H000000FF,&H00000000,&H64000000,0,0,0,0,100,100,0,0,1,2,0,5,20,20,20,1

            [Events]
            Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
            Dialogue: 0,0:00:46.90,0:00:47.60,Dialogue,,40,900,40,,First dialogue JP
            Dialogue: 0,0:00:46.90,0:00:47.60,Dialogue,,900,40,40,,First dialogue CN
            Dialogue: 0,0:00:47.00,0:00:47.50,Dialogue,,60,880,80,,Second dialogue JP
            Dialogue: 0,0:00:47.00,0:00:47.50,Dialogue,,880,60,80,,Second dialogue CN
            Dialogue: 0,0:01:47.90,0:01:48.30,Dialogue,,40,900,40,,Dialogue JP
            Dialogue: 0,0:01:47.90,0:01:48.30,Dialogue,,900,40,40,,Dialogue CN
            Dialogue: 5,0:01:47.50,0:01:48.60,Sign,,0,0,0,,{\pos(340,240)}LV999 guild notice
            Dialogue: 0,0:01:50.40,0:01:50.80,Dialogue,,40,900,40,,Next dialogue JP
            Dialogue: 0,0:01:50.40,0:01:50.80,Dialogue,,900,40,40,,Next dialogue CN
