...
include(":core:model")
include(":core:common")
include(":audio-dsp-core")
include(":audio-measure-core")
include(":audio-measure-android")
include(":topping-control")
include(":audio-dsp-native")
include(":ui-design")
...
include(":player-ijkplayer-android")
include(":scanner")
