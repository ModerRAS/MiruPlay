...
class SettingsSectionDisplayConventionsTest {
    ...
    fun `settings menu summaries are shared`() {
        ...
        assertEquals("10.137.32.158:7890", settingsProxyMenuSummary(enabled = true, host = " 10.137.32.158 ", port = 7890))
        ...
        assertEquals("10.137.32.158:7890", MiruPlaySettingsSection.PROXY.settingsMenuSummary(androidInput))
